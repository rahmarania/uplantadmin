<?php 
    ...
    // tampilkan data user
    $datauser = select("SELECT * FROM pengguna ORDER BY id DESC");
                        ...
                        <div class="card p-2 shadow">
                            <div class="d-flex align-items-center px-2">
                                <div class="card-body text-center">
                                    <a href="tambahuser.php" class="btn btn-outline-success mb-1 mb-1 mt-1"> <div style="padding: 10px; width: 100%">Tambah</div></a>
                                </div>
                            </div>
                                <div style="margin-top:20px"></div>
                            <div class="card-footer bg-white">
                                <small class="text-start fw-bold">Tambah data pengguna</small>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($datauser as $user) : ?>
                                        <tr>
                                            ...
                                            <td><?= $user['telepon'];?></td>                    
                                            <td width="20%">
                                                <a href="lihatuser.php?id=<?= $user['id'];?>" class="btn btn-secondary">Info</a>
                                                <a href="ubahuser.php?id=<?= $user['id'];?>" class="btn btn-warning">Edit</a>
                                                <a href="hapususer.php?id=<?= $user['id'];?>" class="btn btn-danger" onclick="return confirm('Hapus data?')">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<!--     <div class="container mt-5">
        ...
        <a href="tambahuser.php" class="btn btn-outline-success mb-1 mb-4 mt-4">Tambah</a>
